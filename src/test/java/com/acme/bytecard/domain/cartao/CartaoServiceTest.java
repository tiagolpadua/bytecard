...
class CartaoServiceTest {
    ...
    void cadastrar() {
        ...
        Cartao c = cartaoCaptor.getValue();

        assertEquals(cartaoCriado.getNumero(), c.getNumero());
        assertEquals(cartaoCriado.getValidade(), c.getValidade());
        assertEquals(cartaoCriado.getCvv(), c.getCvv());
        assertEquals(cartaoCriado.getCliente(), c.getCliente());
        assertEquals(cartaoCriado.getLimite(), c.getLimite());
        assertEquals(cartaoCriado.getStatus(), c.getStatus());
    }
}